...
public class QA_SG_Customer_Mobile  {
	...
	public QA_SG_Customer_Mobile(String a, String b, String c, String d, String e, boolean f, boolean g, boolean h, boolean i){
		usr = a;
		pw = b;
		ccVeri = c;
		securityAns=d;
	...
	public void screenShot(String error){
		...
		try {
			FileUtils.copyFile(scrFile, new File("C:\\BOSS_Screenshots_"+ bossVersion+"\\SG_Mobile_"+error+".png"));
			pics[picCount++]="C:\\BOSS_Screenshots_"+ bossVersion+"\\SG_Mobile_"+error+".png";
		} catch (IOException e) {
	...
	public boolean homePage(){
		...
		try {
			assertTrue(isElementPresent(By.xpath("//div[@id='page']/div[3]/ul[2]/li/div/div/a/div")));
		} catch (Error e) {
			return false;
		}
		try {
			assertTrue(isElementPresent(By.xpath("//div[@id='page']/div[3]/ul[2]/li[2]/div/div/a/div")));
		} catch (Error e) {
			return false;
		}
		try {
			assertTrue(isElementPresent(By.xpath("//div[@id='page']/div[3]/ul[2]/li[3]/div/div/a/div")));
		} catch (Error e) {
			return false;
		}
		try {
			assertTrue(isElementPresent(By.xpath("//div[@id='page']/div[3]/ul[2]/li[4]/div/div/a/div")));
		} catch (Error e) {
			return false;
		}
		try {
			assertTrue(isElementPresent(By.linkText("Update Billing Info")));
		} catch (Error e) {
			return false;
		}
		return true;
	...
	public boolean recharge(){
		...
		try {
			assertEquals("Your account is not setup for credit card recharges. Please contact Customer Services.", driver.findElement(By.cssSelector("div.toast-item.toast-type-error > p")).getText());
			//result[3]=2;
			return false;
		} catch (Error e) {
	...
	public boolean mobileApp(){
		...
		try {
			assertTrue(isElementPresent(By.cssSelector("img[alt=\"Mobile_app_mobile_en-sg\"]")));
		} catch (Error e) {
			return false;
		}
		try {
	...
	public boolean otherCount(){
		...
		try {
			assertEquals("Other Countries", driver.findElement(By.cssSelector("span")).getText());
		} catch (Error e) {
			return false;
		}
		try {
		...
		try {
			assertTrue(isElementPresent(By.linkText("Boss Revolution Spain")));
		} catch (Error e) {
			return false;
		}
		try {
			assertTrue(isElementPresent(By.linkText("Boss Revolution Germany")));
		} catch (Error e) {
			return false;
		}
		try {
			assertTrue(isElementPresent(By.linkText("Boss Revolution US")));
		} catch (Error e) {
			return false;
		}
		try {
		...
		try {
			assertTrue(isElementPresent(By.linkText("Boss Revolution Hong Kong")));
		} catch (Error e) {
			return false;
		}
		try {
	...
	public boolean imtu(){
		...
		try {
			assertEquals("Your credit card on file can not be used for topups. Please update you credit card in Update Billing info or contact Customer Services.", driver.findElement(By.cssSelector("div.toast-item.toast-type-error > p")).getText());
			//result[6]=2;
			return false;
		} catch (Error e) {
	...
	public void print(){
		...
		System.out.println("");
		System.out.println("**SG Customer Mobile**");
		if(update||payment||links)
			//login//////////////////////
			if(result[1]==1){
