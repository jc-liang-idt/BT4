...
public class QA_UK_Distributor  {
	...
	public QA_UK_Distributor(String a, String b, String c, String d, boolean e, boolean f, boolean g, boolean h){
		usr = a;
		pw = b;
		securityAns = c;
		bossVersion = d;
	...
	public boolean R1(){
		...
		driver.findElement(By.id("business_entity_creation_load_amount")).sendKeys("15");
		...
		Email q = new Email(usr);
		String w = q.getMail3("Marjorie","uk");
		if(!w.equals("hi")){
	...
	public boolean R2(){
		...
		Email q = new Email(usr);
		String w = q.getMail3("Daenerys","uk");
		if(!w.equals("hi")){
		int r = w.indexOf("code");
	...
	public boolean R3(){
		...
		driver.findElement(By.id("business_entity_user_attributes_credit_limit_100")).sendKeys("15");
		driver.findElement(By.id("business_entity_name")).clear();
		...
		Email q = new Email(usr);
		String w = q.getMail3("Catelyn","uk");
		if(!w.equals("hi")){
		int r = w.indexOf("code");
