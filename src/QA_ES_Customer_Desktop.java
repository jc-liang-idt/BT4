...
public class QA_ES_Customer_Desktop  {
	...
	public QA_ES_Customer_Desktop(String a, String b, String c, String d, String e, boolean update, boolean payment, boolean links, boolean q){
		usr = a;
		pw = b;
		ccVeri = c;
		securityAns = d;
	...
	public void screenShot(String error){
		...
		try {
			FileUtils.copyFile(scrFile, new File("C:\\BOSS_Screenshots_"+ bossVersion+"\\ES_Customer_"+error+".png"));
			pics[picCount++]="C:\\BOSS_Screenshots_"+ bossVersion+"\\ES_Customer_"+error+".png";
		} catch (IOException e) {
	...
	public boolean createCust(){
		...
		try {
			assertEquals("GRACIAS POR ELEGIR Boss Revolution", driver.findElement(By.xpath("//form[@id='user_session_new']/div[2]")).getText());
		} catch (Error e) {
			return false;
		}
		return true;
	...
	public boolean login(){
		...
		try {
			assertEquals("ACCEDER", driver.findElement(By.id("subheader_C")).getText());
			...
			try {
				assertEquals("Para mantener su cuenta segura ...", driver.findElement(By.id("subheader_C")).getText());
	...
	public boolean homePage(){
		...
		try {
			assertEquals("Mi Cuenta", driver.findElement(By.id("subheader_C")).getText());
		} catch (Error e) {
			return false;
		}
		try {
			assertTrue(isElementPresent(By.cssSelector("div.title > span")));
		} catch (Error e) {
			return false;
		}
		try {
			assertTrue(isElementPresent(By.cssSelector("#M_Tm > div.title > span")));
		} catch (Error e) {
			return false;
		}
		try {
			assertTrue(isElementPresent(By.id("A_Tm")));
		} catch (Error e) {
			return false;
		}
		try {
			assertTrue(isElementPresent(By.cssSelector("#S_Tm > div.title")));
		} catch (Error e) {
			return false;
		}
		try {
			assertTrue(isElementPresent(By.cssSelector("div.recharge.tab_content_image")));
		} catch (Error e) {
			return false;
		}
		try {
			assertEquals(usr, driver.findElement(By.cssSelector("div.value")).getText());
		} catch (Error e) {
			return false;
		}
		return true;
	...
	public boolean recharge(){
		...
		try {
			assertEquals("Asegúrese de mantener su cuenta con fondos. Usted no quiere verse obligado a pagar altas tasas con su proveedor de servicio o con otro servicio.", driver.findElement(By.cssSelector("div.msg.last")).getText());
		} catch (Error e) {
			return false;
		}
		driver.findElement(By.id("business_entity_banks_attributes_0_cc_verification_code")).clear();
		...
		driver.findElement(By.id("business_entity_submit")).click();
		if(isElementPresent(By.cssSelector("div.toast-item.toast-type-error > p"))) return false;
		if("Su cuenta ha sido recargada con éxito.".equals(driver.findElement(By.cssSelector("p")).getText())){
			return true;
		}
		return false;
	}
	...
	public boolean registeredNumbers(int t){
		...
		driver.findElement(By.xpath("//div[@id='C_T']/div/a[2]/div[2]/span")).click();
		...
		if(!isElementPresent(By.cssSelector("div.toast-item.toast-type-error > p"))&&"Los números registrados se han actualizado correctamente.".equals(driver.findElement(By.cssSelector("p")).getText())){
			return true;
		}else{
			if(t==3) return false;
	...
	public boolean quickCall(){
		...
		if(isElementPresent(By.cssSelector("div.toast-item.toast-type-error > p"))) return false;
		try {
			assertEquals("QuickCall actualizad0 con éxito.", driver.findElement(By.cssSelector("p")).getText());
		} catch (Error e) {
			return false;
		}
		return true;
	...
	public boolean speedDial(){
		...
		driver.findElement(By.id("sddescr1")).sendKeys("Jon Snow");
		...
		driver.findElement(By.name("commit")).click();
		if(isElementPresent(By.cssSelector("div.toast-item.toast-type-error > p"))) return false;
		if("Los números de Marcación Rápida se han actualizado correctamente.".equals(driver.findElement(By.cssSelector("p")).getText())){
			return true;
		}
		return false;
	}
	...
	public boolean callHistory(){
		...
		driver.findElement(By.linkText("Historial de Llamadas")).click();
		try {
			assertEquals("Por favor, seleccione un intervalo de fechas de un mes o menos", driver.findElement(By.cssSelector("div.msg.last")).getText());
		} catch (Error e) {
			return false;
		}
		try {
			assertEquals("Historial de Llamadas", driver.findElement(By.id("subheader_C")).getText());
		} catch (Error e) {
			return false;
		}
		try {
	...
	public boolean billingHist(){
		...
		driver.findElement(By.linkText("Historial de Transferencias")).click();
		try {
			assertEquals("Historial de Transferencias", driver.findElement(By.id("subheader_C")).getText());
		} catch (Error e) {
			return false;
		}
		try {
	...
	public boolean moveService(){
		...
		driver.findElement(By.linkText("Mover Servicio")).click();
		driver.findElement(By.id("phone_number")).clear();
		driver.findElement(By.id("phone_number")).sendKeys(usr);
		driver.findElement(By.cssSelector("input[type=\"submit\"]")).click();
		if("Este número de teléfono no está disponible. Por favor, compruebe si es correcta o póngase en contacto con Servicio al Cliente para obtener ayuda.".equals(driver.findElement(By.cssSelector("p")).getText())){
			return true;
		}
		return false;
	}
	...
	public boolean raf(){
		...
		driver.findElement(By.xpath("(//a[contains(text(),'Amigos Para Siempre')])[2]")).click();
		try {
			assertEquals("Amigos Para Siempre", driver.findElement(By.id("subheader_C")).getText());
		} catch (Error e) {
			return false;
		}
		try {
			assertTrue(isElementPresent(By.linkText("Agrega amigo")));
		} catch (Error e) {
			return false;
		}
		try {
	...
	public boolean vcc(){
		...
		driver.findElement(By.linkText("Tarjeta Virtual de llamada")).click();
		try {
			assertTrue(isElementPresent(By.cssSelector("img[alt=\"Es-es_vcard\"]")));
		} catch (Error e) {
			return false;
		}
		return true;
	...
	public boolean contactUs(){
		...
		try {
			assertEquals("Por favor, díganos por qué usted no está satisfecho con el servicio", driver.findElement(By.cssSelector("div.msg.last")).getText());
		} catch (Error e) {
			return false;
		}
		return true;
	...
	public boolean reqRefund(){
		...
		//driver.findElement(By.id("ui-accordion-accordion_side_menu-header-4")).click();
		driver.findElement(By.linkText("Solicitar un Reembolso")).click();
		try {
			assertEquals("Su tarjeta de crédito, tal y como aparece a continuación le será reembolsado. El reembolso no va a suceder de inmediato. Por favor, permita que nuestro equipo de servicio al cliente el tiempo para procesar su solicitud", driver.findElement(By.cssSelector("div.msg.last")).getText());
		} catch (Error e) {
			return false;
		}
		return true;
	...
	public boolean imtu(){
		...
		driver.findElement(By.linkText("Recarga Móviles")).click();
		driver.findElement(By.linkText("Recargas de Móviles Internacionales")).click();
		try {
			assertEquals("Recargas de Móviles Internacionales", driver.findElement(By.id("subheader_C")).getText());
		} catch (Error e) {
			return false;
		}
		...
		if(isElementPresent(By.cssSelector("div.toast-item.toast-type-error > p"))) return false;
		try {
			assertEquals("Gracias. Su compra se ha realizado exitosamente y el número móvil internacional ha sido recargado.", driver.findElement(By.cssSelector("p")).getText());
		} catch (Error e) {
			return false;
		}
	...
	public boolean dmtu(){
		...
		driver.findElement(By.linkText("Recargas de Móviles Nacionales")).click();
		try {
			assertEquals("Recargas de Móviles Nacionales", driver.findElement(By.id("subheader_C")).getText());
		} catch (Error e) {
			return false;
		}
		try {
		...
		if(isElementPresent(By.cssSelector("div.toast-item.toast-type-error > p"))) return false;
		try {
			assertEquals("Gracias. Su compra se ha realizado exitosamente y el número móvil nacional ha sido recargado.", driver.findElement(By.cssSelector("p")).getText());
		} catch (Error e) {
			return false;
		}
	...
	public boolean rates(){
		...
		try {
			assertEquals("Tarifas", driver.findElement(By.id("subheader_C")).getText());
		} catch (Error e) {
			return false;
		}
		new Select(driver.findElement(By.id("rate_check_country"))).selectByVisibleText("Albania");
		try {
			assertEquals("Albania", driver.findElement(By.cssSelector("td.l")).getText());
		} catch (Error e) {
			return false;
		}
		new Select(driver.findElement(By.id("rate_check_country"))).selectByVisibleText("Faeroe Islands");
		try {
			assertEquals("Faeroe Islands", driver.findElement(By.cssSelector("td.l")).getText());
		} catch (Error e) {
			return false;
		}
		try {
			assertEquals("Nuestro Top 5", driver.findElement(By.xpath("//div[@id='content']/table/tbody/tr/td[2]/table/tbody/tr/td[2]/div")).getText());
		} catch (Error e) {
			return false;
		}
		try {
			assertEquals("Acceso #", driver.findElement(By.xpath("//div[@id='content']/table/tbody/tr/td[2]/table/tbody/tr/td[2]/div[3]")).getText());
		} catch (Error e) {
			return false;
		}
		return true;
	...
	public boolean mobileApp(){
		...
		try {
			assertTrue(isElementPresent(By.cssSelector("img[alt=\"Mobile_app_desktop_es-es\"]")));
		} catch (Error e) {
			return false;
		}
		return true;
	...
	public boolean faq(){
		...
		try {
			assertEquals("Preguntas Frecuentes", driver.findElement(By.id("subheader_C")).getText());
		} catch (Error e) {
			return false;
		}
		return true;
	...
	public boolean dialingTips(){
		...
		driver.findElement(By.xpath("//div[@id='header']/div[3]/ul/li[9]/span")).click();
		driver.findElement(By.linkText("Consejos")).click();
		try {
			assertEquals("CONSEJOS DE MARCACIÓN", driver.findElement(By.id("subheader_C")).getText());
		} catch (Error e) {
			return false;
		}
		return true;
	...
	public boolean hiw(){
		...
		driver.findElement(By.xpath("//div[@id='header']/div[3]/ul/li[9]/span")).click();
		driver.findElement(By.linkText("Como funciona")).click();
		try {
			assertEquals("Cómo Funciona?", driver.findElement(By.id("subheader_C")).getText());
		} catch (Error e) {
			return false;
		}
		return true;
	...
	public boolean features(){
		...
		driver.findElement(By.xpath("//div[@id='header']/div[3]/ul/li[9]/span")).click();
		driver.findElement(By.linkText("Caracteristicas")).click();
		try {
			assertEquals("CARACTERISTICAS", driver.findElement(By.id("subheader_C")).getText());
		} catch (Error e) {
			return false;
		}
		return true;
	...
	/*public boolean wifi(){
		...
		driver.findElement(By.xpath("//div[@id='header']/div[3]/ul/li[9]/span")).click();
		driver.findElement(By.linkText("Wi-Fi Gratis")).click();
		try {
	...
	public boolean raf2(){
		...
		try {
			assertTrue(isElementPresent(By.cssSelector("img[alt=\"Ff_desktop_es-es\"]")));
		} catch (Error e) {
			return false;
		}
		return true;
	...
	public boolean contactUs2(){
		...
		driver.findElement(By.linkText("Contáctanos")).click();
		try {
			assertEquals("PUEDE COMUNICARSE CON NOSOTROS POR EMAIL O TELÉFONO, EN CUALQUIER MOMENTO.", driver.findElement(By.cssSelector("div.msg.bold")).getText());
		} catch (Error e) {
			return false;
		}
		try {
	...
	public boolean reseller(){
		...
		try {
			assertTrue(isElementPresent(By.cssSelector("img[alt=\"Become_dealer_es\"]")));
		} catch (Error e) {
			return false;
		}
		try {
			assertEquals("CONVIÉRTETE EN UN VENDEDOR", driver.findElement(By.id("subheader_C")).getText());
		} catch (Error e) {
			return false;
		}
		return true;
	...
	public void print(){
		...
		System.out.println("");
		System.out.println("**ES Customer Desktop**");
		if(update||payment||links)
			//login//////////////////////
			if(result[1]==1){
