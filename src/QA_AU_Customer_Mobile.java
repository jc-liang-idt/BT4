...
public class QA_AU_Customer_Mobile  {
	...
	public QA_AU_Customer_Mobile(String a, String b, String c, String d, String e, boolean f, boolean g, boolean h, boolean i){
		usr = a;
		pw = b;
		ccVeri = c;
		securityAns=d;
	...
	public void screenShot(String error){
		...
		try {
			FileUtils.copyFile(scrFile, new File("C:\\BOSS_Screenshots_"+ bossVersion+"\\AU_Mobile_"+error+".png"));
			pics[picCount++]="C:\\BOSS_Screenshots_"+ bossVersion+"\\AU_Mobile_"+error+".png";
		} catch (IOException e) {
	...
	public boolean createCust(){
		...
		do{
			...
			driver.findElement(By.id("business_entity_physical_addresses_attributes_0_zip_code")).sendKeys("1234");
	...
	public boolean homePage(){
		...
		try {
			assertTrue(isElementPresent(By.xpath("//div[@id='page']/div[3]/ul[2]/li[5]/div/div/a/div")));
		} catch (Error e) {
			return false;
		}
		return true;
	...
	public boolean mobileApp(){
		...
		try {
			assertTrue(isElementPresent(By.cssSelector("img[alt=\"Mobile_app_mobile_en-au\"]")));
		} catch (Error e) {
			return false;
		}
		try {
	...
	public boolean otherCount(){
		...
		try {
			assertTrue(isElementPresent(By.linkText("Boss Revolution Singapore")));
		} catch (Error e) {
			return false;
		}
		return true;
	...
	public boolean imtu(){
		...
		q.selectByVisibleText("CN");
		driver.findElement(By.id("receiver")).clear();
		driver.findElement(By.id("receiver")).sendKeys("22121234");
	...
	public void print(){
		...
		System.out.println("");
		System.out.println("**AU Customer Mobile**");
		if(update||payment||links)
			//login//////////////////////
			if(result[1]==1){
