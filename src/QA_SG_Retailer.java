...
public class QA_SG_Retailer  {
	...
	public QA_SG_Retailer(String a, String b, String c, String d, boolean e, boolean f, boolean g, boolean h, int i){
		usr = a;
		pw = b;
		securityAnswer = c;
		bossVersion = d;
	...
	public void screenShot(String error){
		...
		case 0: 
			try {
				FileUtils.copyFile(scrFile, new File("C:\\BOSS_Screenshots_"+ bossVersion+"\\SG_Retailer_"+error+".png"));
				pics[picCount++]="C:\\BOSS_Screenshots_"+ bossVersion+"\\SG_Retailer_"+error+".png";
			} catch (IOException e) {
		...
		case 1: 
			try {
				FileUtils.copyFile(scrFile, new File("C:\\BOSS_Screenshots_"+ bossVersion+"\\SG_Cash Retailer_"+error+".png"));
				pics[picCount++]="C:\\BOSS_Screenshots_"+ bossVersion+"\\SG_Cash Retailer_"+error+".png";
			} catch (IOException e) {
				// TODO Auto-generated catch block
				e.printStackTrace();
			}
		...
		case 2: 
			try {
				FileUtils.copyFile(scrFile, new File("C:\\BOSS_Screenshots_"+ bossVersion+"\\SG_Credit Retailer_"+error+".png"));
				pics[picCount++]="C:\\BOSS_Screenshots_"+ bossVersion+"\\SG_Credit Retailer_"+error+".png";
			} catch (IOException e) {
				// TODO Auto-generated catch block
				e.printStackTrace();
			}
	...
	public boolean homePage(){
		...
		try {
			assertEquals("Manage My Customers", driver.findElement(By.cssSelector("span.lbl")).getText());
		} catch (Error e) {
			return false;
		}
		try {
			assertEquals("International Mobile Top-Up", driver.findElement(By.cssSelector("a.c_aqua.prod > span.lbl")).getText());
		} catch (Error e) {
			return false;
		}
		try {
...
/*		try {
	...
	public boolean marketMat(){
		...
		try {
			assertTrue(isElementPresent(By.linkText("SG Boss Revolution IMTU Leaflet.pdf")));
		} catch (Error e) {
			return false;
		}
		try {
			assertTrue(isElementPresent(By.linkText("SG_Boss Revolution Leaflet.pdf")));
		} catch (Error e) {
			return false;
		}
		return true;
	...
	public boolean ratesAccess(){
	    ...
	    try {
	      assertTrue(isElementPresent(By.linkText("See All Rates")));
	    } catch (Error e) {
			return false;
	    }
		return true;
	...
	public void print(){
		...
		System.out.println("");
		System.out.println("**SG Retailer**");
		/////////////////////////////////////////////////
		if(result[1]==1){
