...
public class QA_HK_SalesAgent {
	...
	public QA_HK_SalesAgent(String a, String b, String c, boolean d, boolean e, boolean f, boolean g){
		usr = a;
		pw = b;
		bossVersion = c;
		update = d;
	...
	public void screenShot(String error){
		...
		try {
			FileUtils.copyFile(scrFile, new File("C:\\BOSS_Screenshots_"+ bossVersion+"\\HK_Sales Agent_"+error+".png"));
			pics[picCount++]="C:\\BOSS_Screenshots_"+ bossVersion+"\\HK_Sales Agent_"+error+".png";
		} catch (IOException e) {
	...
	public boolean homePage(){
		...
		try {
			assertTrue(isElementPresent(By.cssSelector("span.nav_button.nav_button_reports")));
		} catch (Error e) {
			return false;
		}
		try {
	...
	public void print(){
		...
		System.out.println("");
		System.out.println("**HK Sales Agent**");
		//login//////////////////////
		if(result[0]==1){
