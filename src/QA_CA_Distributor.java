...
public class QA_CA_Distributor  {
	...
	public QA_CA_Distributor(String a, String b, String c, String d, boolean e, boolean f, boolean g, boolean h){
		usr = a;
		pw = b;
		securityAns = c;
		bossVersion = d;
	...
	public void screenShot(String error){
		...
		try {
			FileUtils.copyFile(scrFile, new File("C:\\BOSS_Screenshots_"+ bossVersion+"\\CA_Distributor_"+error+".png"));
			pics[picCount++]="C:\\BOSS_Screenshots_"+ bossVersion+"\\CA_Distributor_"+error+".png";
		} catch (IOException e) {
	...
	public boolean R1(){
		...
		driver.findElement(By.id("business_entity_creation_load_amount")).sendKeys("10");
		...
		driver.findElement(By.id("business_entity_phones_attributes_0_number")).clear();
		driver.findElement(By.id("business_entity_phones_attributes_0_number")).sendKeys("1111111111");
		...
		driver.findElement(By.id("business_entity_physical_addresses_attributes_0_city")).sendKeys("brampton");
		...
		Email q = new Email(usr);
		String w = q.getMail3("Marjorie","ca");
		if(!w.equals("hi")){		
	...
	public boolean R2(){
		...
		Email q = new Email(usr);
		String w = q.getMail3("Daenerys","ca");
		if(!w.equals("hi")){		
		int r = w.indexOf("code");
	...
	public boolean manageSales(){
		...
		driver.findElement(By.linkText("Manage Sales People")).click();
		try {
			assertEquals("Manage Sales People", driver.findElement(By.cssSelector("h1")).getText());
		} catch (Error e) {
			return false;
		}
		newNum="t"+randNum("1");
		...
		driver.findElement(By.id("business_entity_user_attributes_cash_limit_100")).sendKeys("40");
	...
	public boolean reports(){
		...
		try {
			assertEquals("My Referrals", driver.findElement(By.xpath("//div[@id='content']/table/tbody/tr/td[2]/div[2]/ul/li[5]/a/span[2]")).getText());
		} catch (Error e) {
			return false;
		}
		try {
		...
		try {
			assertEquals("Retailer Signup", driver.findElement(By.xpath("//div[@id='content']/table/tbody/tr/td[2]/div[2]/ul/li[6]/a/span[2]")).getText());
		} catch (Error e) {
			return false;
		}
		try {
		...
		try {
			assertEquals("Retailers", driver.findElement(By.xpath("//div[@id='content']/table/tbody/tr/td[2]/div[4]/ul/li[3]/a/span[2]")).getText());
		} catch (Error e) {
			return false;
		}
		try {
			assertEquals("Retailer Activity", driver.findElement(By.xpath("//div[@id='content']/table/tbody/tr/td[2]/div[4]/ul/li[2]/a/span[2]")).getText());
		} catch (Error e) {
			return false;
		}
		...
		try {
			assertTrue(isElementPresent(By.xpath("//div[@id='content']/form/div[3]")));
		} catch (Error e) {
			return false;
		}
		try {
		...
		driver.findElement(By.id("report_link")).click();
		System.out.println("Retailers Activity Report looks Ok");
		return true;
	}
	...
	public boolean marketMat(){
		...
		try {
			assertTrue(isElementPresent(By.linkText("BOSS PAKISTAN leaflet ext.jpg")));
		} catch (Error e) {
			return false;
		}
		try {
			assertTrue(isElementPresent(By.linkText("BOSS INDIA leaflet ext.jpg")));
		} catch (Error e) {
			return false;
		}
		return true;
	...
	public boolean contUs(){
		...
		try {
			assertEquals("Please call Customer Services at 800-688-1509.", driver.findElement(By.xpath("//div[@id='content']/table/tbody/tr/td[2]/p")).getText());
		} catch (Error e) {
			return false;
		}
		try {
			assertTrue(isElementPresent(By.cssSelector("div.r > a")));
		} catch (Error e) {
			return false;
		}
	...
	public boolean compCard(){
		...
		try {
			assertTrue(isElementPresent(By.linkText("© IDT Telecom Canada Corp. All rights reserved")));
		} catch (Error e) {
			return false;
		}
		try {
	...
	public boolean homePage(){
		...
		try {
			assertEquals("Register Retailer", driver.findElement(By.cssSelector("span.lbl")).getText());
		} catch (Error e) {
			return false;
		}
		try {
			assertEquals("Manage Retailers", driver.findElement(By.cssSelector("a.c_lime.prod > span.lbl")).getText());
		} catch (Error e) {
			return false;
		}
		try {
			assertEquals("Manage Sales People", driver.findElement(By.cssSelector("a.c_orange.prod > span.lbl")).getText());
		} catch (Error e) {
			return false;
		}
		return true;
	...
	public void print(){
		...
		System.out.println("");
		System.out.println("**CA Distributor**");
		//login//////////////////////
		if(result[0]==1){
