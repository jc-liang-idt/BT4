...
public class Template_Distributor  {
	...
	//might change
	public Template_Distributor(String a, String b, String c, String d, boolean e, boolean f, boolean g, boolean h){
		usr = a;
		pw = b;
		securityAns = c;
		bossVersion = d;
	...
	public void setUp() throws Exception {
		...
		if(qa==0){
			baseUrl = "http://*INSERT REGION*.bossqa.cstage01.n2p.com/";            
		}else{
			baseUrl = "http://*INSERT REGION*.bossqa"+qa+".cstage01.n2p.com/";
		}
	...
	public void screenShot(String error){
		...
		try {
			FileUtils.copyFile(scrFile, new File("C:\\BOSS_Screenshots_"+ bossVersion+"\\UK_Distributor_"+error+".png"));
			pics[picCount++]="C:\\BOSS_Screenshots_"+ bossVersion+"\\UK_Distributor_"+error+".png";
		} catch (IOException e) {
	...
	public String randNum(String w){
		String q;
		do
			q="440" + String.valueOf((int)(Math.floor((Math.random() * 100000000)+899999999)));
	...
	public boolean updateInfo(){
		...
		try {
			assertEquals("Billing Cycle", driver.findElement(By.xpath("//form[@id='edit_business_entity_6162069']/div[4]/label")).getText());
		} catch (Error e) {
			return false;
		}
		try {
			assertEquals("Payments", driver.findElement(By.xpath("//form[@id='edit_business_entity_6162069']/div[7]/label")).getText());
		} catch (Error e) {
			return false;
		}
		return true;
	...
	public boolean contUs(){
		...
		try {
			assertEquals("Please call Customer Services at 0330 777 1384.", driver.findElement(By.xpath("//div[@id='content']/table/tbody/tr/td[2]/p")).getText());
		} catch (Error e) {
			return false;
		}
	...
	public boolean test() throws Exception {
		...
		if(update){
			/////////////////////////////////////////////////
			if(updateInfo()){
				System.out.println("[Sucess]Updated Personal Deatils Successfully");
				result[1]=1;
			}else{
				screenShot("Personal Details");
	...
	public void print(){
		...
		System.out.println("");
		System.out.println("**UK Distributor**");
		//login//////////////////////
		if(result[0]==1){
		...
		if(creation){
			if(result[3]==1){
				System.out.println(r+") Created new Cash-Cash Retailer Successfully - "+r1+":1234");
				results[r++]=r-1+") Created new Cash-Cash Retailer Successfully - "+r1+":1234";
			}else{
			...
			////////////////////////
			if(result[4]==1){
				System.out.println(r+") Created new Cash-Credit Retailer Successfully - "+r2+":1234");
				results[r++]=r-1+") Created new Cash-Credit Retailer Successfully - "+r2+":1234";
			}else{
			...
			////////////////////////
			if(result[5]==1){
				System.out.println(r+") Created new Credit-Credit Retailer Successfully - "+r3+":1234");
				results[r++]=r-1+") Created new Credit-Credit Retailer Successfully - "+r3+":1234";
			}else{
			...
			if(result[6]==1){
				System.out.println(r+") Created new Credit-Invoice Retailer Successfully - "+r4+":1234");
				results[r++]=r-1+") Created new Credit-Invoice Retailer Successfully - "+r4+":1234";
			}else{
