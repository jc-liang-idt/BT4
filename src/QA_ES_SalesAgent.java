...
public class QA_ES_SalesAgent {
	...
	private String r1,r2,r3,r4,r1p,r2p,r3p,r4p;
	private String usr;
	private String pw;
	...
	public QA_ES_SalesAgent(String a, String b, String c, boolean d, boolean e, boolean f, boolean g){
		usr = a;
		pw = b;
		bossVersion = c;
		update = d;
	...
	public void screenShot(String error){
		...
		try {
			FileUtils.copyFile(scrFile, new File("C:\\BOSS_Screenshots_"+ bossVersion+"\\ES_Sales Agent_"+error+".png"));
			pics[picCount++]="C:\\BOSS_Screenshots_"+ bossVersion+"\\ES_Sales Agent_"+error+".png";
		} catch (IOException e) {
	...
	public boolean updateInfo(){
		...
		/*try {
			assertEquals("Update Password", driver.findElement(By.cssSelector("h1")).getText());
		} catch (Error e) {
			return false;
		}*/
		try {
	...
	public boolean defaultComm(){
		...
		try {
			assertEquals("Comisiones por defecto Minorista", driver.findElement(By.cssSelector("h2")).getText());
		} catch (Error e) {
			return false;
		}
		try {
			assertEquals("Mis Comisiones", driver.findElement(By.cssSelector("form > h2")).getText());
		} catch (Error e) {
			return false;
		}
		try {
			assertEquals("Comisiones minorista", driver.findElement(By.xpath("//div[@id='content']/table/tbody/tr/td[2]/form/h2[2]")).getText());
		} catch (Error e) {
			return false;
		}
		return true;
	...
	public boolean reports(){
		...
		try {
			assertEquals("Resumen de Mis", driver.findElement(By.xpath("//div[@id='content']/table/tbody/tr/td[2]/div[2]/ul/li[3]/a/span[2]")).getText());
		} catch (Error e) {
			return false;
		}
		try {
		...
		try {
			assertEquals("Registrar Minoristas", driver.findElement(By.xpath("//div[@id='content']/table/tbody/tr/td[2]/div[2]/ul/li[4]/a/span[2]")).getText());
		} catch (Error e) {
			return false;
		}
		try {
		...
		try {
			assertTrue(isElementPresent(By.id("prodtype")));
		} catch (Error e) {
			return false;
		}
		try {
		...
		try {
			assertEquals("Mi Informe Resumen", driver.findElement(By.cssSelector("h1")).getText());
		} catch (Error e) {
			return false;
		}
		try {
		...
		driver.findElement(By.id("report_link")).click();
		System.out.println("Mi Informe Resumen looks Ok");
...
/*		try {
			assertEquals("Por favor llame a Servicio al Cliente 917 714 037.", driver.findElement(By.xpath("//div[@id='content']/table/tbody/tr/td[2]/p")).getText());
		} catch (Error e) {
			return false;
		}*/
		return true;
	...
	public void print(){
		...
		System.out.println("");
		System.out.println("**ES Sales Agent**");
		//login//////////////////////
		if(result[0]==1){
