...
public class QA_DE_SalesAgent {
	...
	public QA_DE_SalesAgent(String a, String b, String c, boolean d, boolean e, boolean f, boolean g){
		usr = a;
		pw = b;
		bossVersion = c;
		update = d;
	...
	public void screenShot(String error){
		...
		try {
			FileUtils.copyFile(scrFile, new File("C:\\BOSS_Screenshots_"+ bossVersion+"\\DE_Sales Agent_"+error+".png"));
			pics[picCount++]="C:\\BOSS_Screenshots_"+ bossVersion+"\\DE_Sales Agent_"+error+".png";
		} catch (IOException e) {
	...
	public void print(){
		...
		System.out.println("");
		System.out.println("**DE Sales Agent**");
		//login//////////////////////
		if(result[0]==1){
