...
public class QA_AU_Distributor  {
	...
	public QA_AU_Distributor(String a, String b, String c, String d, boolean e, boolean f, boolean g, boolean h){
		usr = a;
		pw = b;
		securityAns = c;
		bossVersion = d;
	...
	public void screenShot(String error){
		...
		try {
			FileUtils.copyFile(scrFile, new File("C:\\BOSS_Screenshots_"+ bossVersion+"\\AU_Distributor_"+error+".png"));
			pics[picCount++]="C:\\BOSS_Screenshots_"+ bossVersion+"\\AU_Distributor_"+error+".png";
		} catch (IOException e) {
	...
	//	driver.findElement(By.name("commit")).click();
		...
		try {
			assertEquals("Billing Cycle", driver.findElement(By.xpath("//form[@id='edit_business_entity_6116741']/div[4]/label")).getText());
		} catch (Error e) {
			return false;
		}
		try {
			assertEquals("Payments", driver.findElement(By.xpath("//form[@id='edit_business_entity_6116741']/div[7]/label")).getText());
		} catch (Error e) {
			return false;
		}
		return true;
	...
	public boolean homePage(){
		...
		try {
			assertEquals("Boss Revolution Distributors - Home", driver.getTitle());
		} catch (Error e) {
			return false;
		}
		try {
		...
		try {
			assertTrue(isElementPresent(By.linkText("Register Retailer")));
		} catch (Error e) {
			return false;
		}
		try {
	...
	public void print(){
		...
		System.out.println("");
		System.out.println("**AU Distributor**");
		//login//////////////////////
		if(result[0]==1){
