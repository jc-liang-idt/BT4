...
public class QA_DE_Agent  {
	...
	public QA_DE_Agent(String a, String b, String c, String d, boolean e, boolean f, boolean g){
		usr = a;
		pw = b;
		secAns = c;
		bossVersion = d;
	...
	public void screenShot(String error){
		...
		try {
			FileUtils.copyFile(scrFile, new File("C:\\BOSS_Screenshots_"+ bossVersion+"\\DE_Agent_"+error+".png"));
			pics[picCount++]="C:\\BOSS_Screenshots_"+ bossVersion+"\\DE_Agent_"+error+".png";
		} catch (IOException e) {
