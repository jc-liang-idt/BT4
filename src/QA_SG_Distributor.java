...
public class QA_SG_Distributor  {
	...
	public QA_SG_Distributor(String a, String b, String c, String d, boolean e, boolean f, boolean g, boolean h){
		usr = a;
		pw = b;
		securityAns = c;
		bossVersion = d;
	...
	public void screenShot(String error){
		...
		try {
			FileUtils.copyFile(scrFile, new File("C:\\BOSS_Screenshots_"+ bossVersion+"\\SG_Distributor_"+error+".png"));
			pics[picCount++]="C:\\BOSS_Screenshots_"+ bossVersion+"\\SG_Distributor_"+error+".png";
		} catch (IOException e) {
	...
	public String randNum(String w){
		String q;
		do
			q="65" + String.valueOf((int)(Math.floor((Math.random() * 100000000)+899999999)));
	...
	public boolean updateInfo(){
		...
		try {
			assertEquals("Billing Cycle", driver.findElement(By.xpath("//form[@id='edit_business_entity_6129911']/div[4]/label")).getText());
		} catch (Error e) {
			return false;
		}
		try {
			assertEquals("Payments", driver.findElement(By.xpath("//form[@id='edit_business_entity_6129911']/div[7]/label")).getText());
		} catch (Error e) {
			return false;
		}
		return true;
	...
	public boolean R1(){
		...
		Email q = new Email(usr);
		String w = q.getMail3("Marjorie","sg");
		if(!w.equals("hi")){		
	...
	public boolean R2(){
		...
		Email q = new Email(usr);
		String w = q.getMail3("Daenerys","sg");
		if(!w.equals("hi")){		
		int r = w.indexOf("code");
	...
	public boolean R3(){
		...
		Email q = new Email(usr);
		String w = q.getMail3("Catelyn","sg");
		if(!w.equals("hi")){		
		int r = w.indexOf("code");
	...
	public boolean contUs(){
		...
		try {
			assertEquals("Please call Customer Services at 6415 9093.", driver.findElement(By.xpath("//div[@id='content']/table/tbody/tr/td[2]/p")).getText());
		} catch (Error e) {
			return false;
		}
	...
	public void print(){
		...
		System.out.println("");
		System.out.println("**SG Distributor**");
		//login//////////////////////
		if(result[0]==1){
