...
public class QA_UK_Customer_Mobile  {
	...
	public QA_UK_Customer_Mobile(String a, String b, String c, String d, boolean e, boolean f, boolean g, boolean h){
		usr = a;
		pw = b;
		ccVeri = c;
		bossVersion = d;
	...
	public void screenShot(String error){
		...
		try {
			FileUtils.copyFile(scrFile, new File("C:\\BOSS_Screenshots_"+ bossVersion+"\\UK_Mobile_"+error+".png"));
			pics[picCount++]="C:\\BOSS_Screenshots_"+ bossVersion+"\\UK_Mobile_"+error+".png";
		} catch (IOException e) {
	...
	public boolean createCust(){
		...
		do{
			...
			//driver.findElement(By.id("business_entity_banks_attributes_0_payment_method_id")).click();
	...
	public boolean recharge(){
		...
		if(isElementPresent(By.cssSelector("div.toast-item.toast-type-error")))
			if("Your account is not setup for credit card recharges. Please contact Customer Services.".equals(driver.findElement(By.cssSelector("div.toast-item.toast-type-error")).getText()))
				return false;
		new Select(driver.findElement(By.id("recharge_source"))).selectByVisibleText("Credit Card");
	...
	public String randNum(String w){
		String q;
		do
			q="442" + String.valueOf((int)(Math.floor((Math.random() * 100000000)+899999999)));
	...
	public boolean AccessNumbers(){
		...
		try {
			assertTrue(isElementPresent(By.xpath("//div[@id='page']/div[4]/ul/li[7]/div/div/a")));
		} catch (Error e) {
			return false;
		}
		try {
			assertTrue(isElementPresent(By.xpath("//div[@id='page']/div[4]/ul/li[19]/div/div/a")));
		} catch (Error e) {
			return false;
		}
		try {
			assertTrue(isElementPresent(By.xpath("//div[@id='page']/div[4]/ul/li[22]/div/div/a")));
		} catch (Error e) {
			return false;
		}
		return true;
	...
	public boolean wib(){
		...
		try {
			assertTrue(isElementPresent(By.xpath("//div[@id='page']/div[4]/div[3]/div")));
		} catch (Error e) {
			return false;
		}
		try {
			assertTrue(isElementPresent(By.cssSelector("span.ui-btn-text")));
		} catch (Error e) {
			return false;
		}
		return true;
	...
	public boolean mobileApp(){
		...
		try {
			assertEquals("MOBILE APPS", driver.findElement(By.cssSelector("span")).getText());
		} catch (Error e) {
			return false;
		}
		try {
			assertTrue(isElementPresent(By.cssSelector("img[alt=\"Boss Revolution on iTunes\"]")));
		} catch (Error e) {
			return false;
		}
		try {
		...
		try {
			assertTrue(isElementPresent(By.cssSelector("img[alt=\"Mobile_app_mobile_en-gb\"]")));
		} catch (Error e) {
			return false;
		}
		driver.findElement(By.xpath("//div[@id='page']/div[4]/table/tbody/tr/td[2]/div[2]/h3/a/span/span[2]")).click();
		try {
			assertEquals("The same low per minute call rates", driver.findElement(By.cssSelector("div.ui-collapsible-content > div.msg")).getText());
		} catch (Error e) {
			return false;
		}
		driver.findElement(By.xpath("//div[@id='page']/div[4]/table/tbody/tr/td[2]/div[3]/h3/a/span/span[2]")).click();
		try {
			assertEquals("Call directly from your phone contacts", driver.findElement(By.xpath("//div[@id='page']/div[4]/table/tbody/tr/td[2]/div[3]/div/div")).getText());
		} catch (Error e) {
			return false;
		}
		driver.findElement(By.xpath("//div[@id='page']/div[4]/table/tbody/tr/td[2]/div[4]/h3/a/span/span[2]")).click();
		try {
			assertEquals("Make calls using a mobile, Wi-Fi or data connection", driver.findElement(By.xpath("//div[@id='page']/div[4]/table/tbody/tr/td[2]/div[4]/div/div")).getText());
		} catch (Error e) {
			return false;
		}
		driver.findElement(By.xpath("//div[@id='page']/div[4]/table/tbody/tr/td[2]/div[5]/h3/a/span/span[2]")).click();
		try {
			assertEquals("In store, online or in app", driver.findElement(By.xpath("//div[@id='page']/div[4]/table/tbody/tr/td[2]/div[5]/div/div")).getText());
		} catch (Error e) {
			return false;
		}
		return true;
	...
	public boolean help(){
		...
		try {
			assertEquals("Boss Revolution Customers - FAQ - Free Wi-Fi", driver.getTitle());
		} catch (Error e) {
			return false;
		}
		try {
			assertTrue(isElementPresent(By.id("WIFI1")));
		} catch (Error e) {
			return false;
		}
		try {
			assertTrue(isElementPresent(By.id("WIFI3")));
		} catch (Error e) {
			return false;
		}
		try {
			assertTrue(isElementPresent(By.id("WIFI5")));
		} catch (Error e) {
			return false;
		}
		try {
			assertTrue(isElementPresent(By.id("wifi_login_select_idt")));
		} catch (Error e) {
			return false;
		}
		System.out.println("		Free Wi-Fi Looks OK");
		driver.get(baseUrl + "/customers/faq");*/
		driver.findElement(By.linkText("Mobile Apps")).click();
		try {
			assertEquals("FAQ - Mobile Apps", driver.findElement(By.cssSelector("span")).getText());
		} catch (Error e) {
			return false;
		}
		try {
		...
		try {
			assertTrue(isElementPresent(By.id("MA16")));
		} catch (Error e) {
			return false;
		}
		try {
		...
		try {
			assertTrue(isElementPresent(By.id("MA4")));
		} catch (Error e) {
			return false;
		}
	...
	public void print(){
		...
		System.out.println("");
		System.out.println("**UK Customer Mobile**");
		if(update||payment||links)
			//login//////////////////////
			if(result[1]==1){
