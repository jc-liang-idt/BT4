...
public class QA_UK_SalesAgent {
	...
	public QA_UK_SalesAgent(String a, String b, String c, boolean d, boolean e, boolean f, boolean g){
		usr = a;
		pw = b;
		bossVersion = c;
		update = d;
	...
	public void screenShot(String error){
		...
		try {
			FileUtils.copyFile(scrFile, new File("C:\\BOSS_Screenshots_"+ bossVersion+"\\UK_Sales Agent_"+error+".png"));
			pics[picCount++]="C:\\BOSS_Screenshots_"+ bossVersion+"\\UK_Sales Agent_"+error+".png";
		} catch (IOException e) {
	...
	public boolean R3(){
		...
		driver.findElement(By.id("business_entity_user_attributes_credit_limit_100")).sendKeys("5");
		driver.findElement(By.id("business_entity_name")).clear();
	...
	public boolean manageRetail(){
		...
		try {
			assertTrue(isElementPresent(By.id("ec__c")));
		} catch (Error e) {
			return false;
		}
	...
	public void print(){
		...
		System.out.println("");
		System.out.println("**UK Sales Agent**");
		//login//////////////////////
		if(result[0]==1){
