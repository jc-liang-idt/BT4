...
public class QA_DE_Distributor  {
	...
	public QA_DE_Distributor(String a, String b, String c, String d, boolean e, boolean f, boolean g, boolean h){
		usr = a;
		pw = b;
		securityAns = c;
		bossVersion = d;
	...
	public void screenShot(String error){
		...
		try {
			FileUtils.copyFile(scrFile, new File("C:\\BOSS_Screenshots_"+ bossVersion+"\\DE_Distributor_"+error+".png"));
			pics[picCount++]="C:\\BOSS_Screenshots_"+ bossVersion+"\\DE_Distributor_"+error+".png";
		} catch (IOException e) {
	...
	//	driver.findElement(By.name("commit")).click();
		...
		try {
			assertEquals("Billing Cycle", driver.findElement(By.xpath("//form[@id='edit_business_entity_6113811']/div[4]/label")).getText());
		} catch (Error e) {
			return false;
		}
		try {
			assertEquals("Payments", driver.findElement(By.xpath("//form[@id='edit_business_entity_6113811']/div[7]/label")).getText());
		} catch (Error e) {
			return false;
		}
		return true;
	...
	public boolean R1(){
		...
		Email q = new Email(usr);
		String w = q.getMail3("Marjorie","de");
		if(!w.equals("hi")){		
	...
	public boolean R2(){
		...
		Email q = new Email(usr);
		String w = q.getMail3("Daenerys","de");
		if(!w.equals("hi")){		
		int r = w.indexOf("code");
	...
	public boolean R3(){
		...
		Email q = new Email(usr);
		String w = q.getMail3("Catelyn","de");
		if(!w.equals("hi")){		
		int r = w.indexOf("code");
	...
	public boolean contUs(){
		...
		try {
			assertEquals("Boss Revolution Distributors - Contact Us", driver.getTitle());
		} catch (Error e) {
			return false;
		}
		/*try {
			assertEquals("Please call Customer Services at 0302 555 8914.", driver.findElement(By.xpath("//div[@id='content']/table/tbody/tr/td[2]/p")).getText());
		} catch (Error e) {
			return false;
		}*/
		return true;
	...
	public void print(){
		...
		System.out.println("");
		System.out.println("**DE Distributor**");
		//login//////////////////////
		if(result[0]==1){
