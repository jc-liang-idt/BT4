...
public class QA_HK_Retailer  {
	...
	public QA_HK_Retailer(String a, String b, String c, String d, boolean e, boolean f, boolean g, boolean h, int i){
		usr = a;
		pw = b;
		securityAnswer = c;
		bossVersion = d;
	...
	public void screenShot(String error){
		...
		case 0: 
			try {
				FileUtils.copyFile(scrFile, new File("C:\\BOSS_Screenshots_"+ bossVersion+"\\HK_Retailer_"+error+".png"));
				pics[picCount++]="C:\\BOSS_Screenshots_"+ bossVersion+"\\HK_Retailer_"+error+".png";
			} catch (IOException e) {
		...
		case 1: 
			try {
				FileUtils.copyFile(scrFile, new File("C:\\BOSS_Screenshots_"+ bossVersion+"\\HK_Cash Retailer_"+error+".png"));
				pics[picCount++]="C:\\BOSS_Screenshots_"+ bossVersion+"\\HK_Cash Retailer_"+error+".png";
			} catch (IOException e) {
				// TODO Auto-generated catch block
				e.printStackTrace();
			}
		...
		case 2: 
			try {
				FileUtils.copyFile(scrFile, new File("C:\\BOSS_Screenshots_"+ bossVersion+"\\HK_Credit Retailer_"+error+".png"));
				pics[picCount++]="C:\\BOSS_Screenshots_"+ bossVersion+"\\HK_Credit Retailer_"+error+".png";
			} catch (IOException e) {
				// TODO Auto-generated catch block
				e.printStackTrace();
			}
	...
	public boolean refund(){
		...
		if(isElementPresent(By.xpath("//div[@id='content']/table/tbody/tr/td[2]"))){
			if("Please call Customer Services at 2159 9083.".equals(driver.findElement(By.xpath("//div[@id='content']/table/tbody/tr/td[2]")).getText())){
				result[26]=2;
				return true;
			}
		}
...
/*			if(imtu()){
	...
	public void print(){
		...
		System.out.println("");
		System.out.println("**HK Retailer**");
		/////////////////////////////////////////////////
		if(result[1]==1){
