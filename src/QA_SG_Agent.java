...
public class QA_SG_Agent  {
	...
	public QA_SG_Agent(String a, String b, String c, boolean d, boolean e, boolean f){
		usr = a;
		pw = b;
		bossVersion = c;
		creation = d;
	...
	public void screenShot(String error){
		...
		try {
			FileUtils.copyFile(scrFile, new File("C:\\BOSS_Screenshots_"+ bossVersion+"\\SG_Agent_"+error+".png"));
			pics[picCount++]="C:\\BOSS_Screenshots_"+ bossVersion+"\\SG_Agent_"+error+".png";
		} catch (IOException e) {
	...
	public boolean login(){
		...
		try {
			...
			try {
				...
				driver.findElement(By.id("security_answer")).sendKeys();
