...
public class QA_CA_SalesAgent {
	...
	public QA_CA_SalesAgent(String a, String b, String c, boolean d, boolean e, boolean f, boolean g){
		usr = a;
		pw = b;
		bossVersion = c;
		update = d;
	...
	public void screenShot(String error){
		...
		try {
			FileUtils.copyFile(scrFile, new File("C:\\BOSS_Screenshots_"+ bossVersion+"\\CA_Sales Agent_"+error+".png"));
			pics[picCount++]="C:\\BOSS_Screenshots_"+ bossVersion+"\\CA_Sales Agent_"+error+".png";
		} catch (IOException e) {
	...
	public boolean manageRetail(){
		...
		Select a = new Select(driver.findElement(By.id("ec__c")));
	...
	public boolean reports(){
		...
		try {
			assertEquals("Commission", driver.findElement(By.linkText("Commission")).getText());
		} catch (Error e) {
			return false;
		}
		try {
			assertEquals("My Summary", driver.findElement(By.xpath("//div[@id='content']/table/tbody/tr/td[2]/div[2]/ul/li[3]/a/span[2]")).getText());
		} catch (Error e) {
			return false;
		}
		try {
		...
		try {
			assertEquals("Retailer Signup", driver.findElement(By.xpath("//div[@id='content']/table/tbody/tr/td[2]/div[2]/ul/li[4]/a/span[2]")).getText());
		} catch (Error e) {
			return false;
		}
		try {
	    ...
	    driver.findElement(By.cssSelector("span.nav_button.nav_button_card")).click();
	    try {
	...
	public void print(){
		...
		System.out.println("");
		System.out.println("**CA Sales Agent**");
		//login//////////////////////
		if(result[0]==1){
