...
public class QA_AU_Agent  {
	...
	public QA_AU_Agent(String a, String b, String c, boolean e, boolean f, boolean g){
		usr = a;
		pw = b;
		//secAns = c;
		bossVersion = c;
	...
	public void screenShot(String error){
		...
		try {
			FileUtils.copyFile(scrFile, new File("C:\\BOSS_Screenshots_"+ bossVersion+"\\AU_Agent_"+error+".png"));
			pics[picCount++]="C:\\BOSS_Screenshots_"+ bossVersion+"\\AU_Agent_"+error+".png";
		} catch (IOException e) {
	...
	public boolean login(){
		...
		try {
			...
			try {
				...
				driver.findElement(By.id("security_answer")).sendKeys("123");
